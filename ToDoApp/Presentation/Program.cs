...
namespace ToDoApp.Presentation
{
    public class Program
    {
        ...
        private static ITokenService _tokenService = null!;
        ...
        public static async Task Main(string[] args)
        {
            ...
            {
                // Initialize services
                (_authService, _taskManager, _tokenService, _logger) = Bootstrapper.Build();
        ...
        private static async Task SearchTasksAsync()
        {
            Console.Clear();
        ...
        private static async Task SortTasksByDateAsync()
        {
            Console.Clear();
        ...
        private static async Task FilterTasksByCompletionAsync()
        {
            Console.Clear();
